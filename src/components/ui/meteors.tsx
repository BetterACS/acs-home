			...
			{meteors.map((el, idx) => (
				<span
					...
					className={cn(
						...
						"before:content-[''] before:absolute before:top-1/2 before:transform before:-translate-y-[50%] before:w-[50px] before:h-[4px] before:bg-gradient-to-r before:from-[#316ade] before:to-transparent",
						className
					)}
					style={{
						top: 0,
